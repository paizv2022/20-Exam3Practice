...
def run_test_practice_problem3():
    ...
    ###########################################################################
    expected = [0, 1, 2, 6]
    actual = practice_problem3(0, 4, 0.45)
    print('Expected:', expected)
    print('Actual:  ', actual)

    expected = [6, 7, 8, 12, 13, 14, 19, 20, 21,25]
    actual = practice_problem3(3, 10, 0.1)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def practice_problem3(start, n, threshold):
    ...
    ###########################################################################
    # DIFFICULTY AND TIME RATINGS (see top of his file for explanation)
    #    DIFFICULTY:      5
